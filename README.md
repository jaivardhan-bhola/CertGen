...
<a href = 'https://code.visualstudio.com/'>
  ...
  <a href="https://github.com/jaivardhan-bhola/CertGen" target="_blank">
  <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg" />
</a>
<a href="https://github.com/jaivardhan-bhola/CertGen/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-brightgreen.svg"></a>  
...
# Description
> A certificate generator for Events
...
# Usage
<li> Copy the templates to the templates directory. Follow convention in code.
<li> Make data.csv in data directory. Name of participant should be the first column.
<li> Place convention
	<ol> <li> 0 for participation only
	<li> 1,2,3,4 for positions
  <li> 5 for extra certs
	<li> 6 for organising
  </ol>
<li> Run
...
This project is [MIT](https://github.com/jaivardhan-bhola/CertGen/blob/main/LICENSE) licensed.
***
